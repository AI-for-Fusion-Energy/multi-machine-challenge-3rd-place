...
def Train_and_Validate(net,optimizer,scheduler,criterion,max_norm, train_shotlist,validate_shotlist,max_epoch,break_loss):
    ...
    for epoch in range(max_epoch):
        Train_Loss_Epoch,T_accu = Train_c3(net,optimizer,scheduler,criterion,train_shotlist,epoch)
        Validate_Loss_Epoch,V_accu = Validate_c3(net,criterion,validate_shotlist,epoch)
...
def Train_c3(net,optimizer,scheduler,criterion,train_shotlist,epoch):
    Train_Loss_Epoch = []
...
def Validate_c3(net,criterion,validate_shotlist,epoch):
    Validate_Loss_Epoch = []
